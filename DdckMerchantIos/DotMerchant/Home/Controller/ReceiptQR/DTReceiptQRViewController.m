...
- (void)viewDidLoad {
    ...
    self.qrImage = [SGQRCodeGenerateManager generateWithDefaultQRCodeData:[NSString stringWithFormat:@"pay=%zd", [TXModelAchivar getUserModel].shopId] imageViewWidth:200];
